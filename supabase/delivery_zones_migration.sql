-- =====================================================
-- Migration: Drop and Recreate Delivery Zones System
-- Description: Remove tabelas e políticas existentes e 
--              recria o sistema completo de zonas de entrega
-- =====================================================

-- 1. DROP EXISTING OBJECTS (if they exist)
-- =====================================================
DROP TRIGGER IF EXISTS update_delivery_zones_updated_at ON public.delivery_zones;
DROP POLICY IF EXISTS "Store owners can manage delivery zones" ON public.delivery_zones;
...
-- 7. UPDATE DEFAULT EMPLOYEE PERMISSIONS
-- =====================================================
