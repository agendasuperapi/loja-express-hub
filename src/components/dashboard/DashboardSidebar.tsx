...
export const DashboardSidebar = ({ activeTab, onTabChange, storeLogo, storeName, isEmployee, employeePermissions }: DashboardSidebarProps) => {
  ...
  return (
    <motion.div
      ...
      className="hidden md:flex w-32 bg-gray-50 dark:bg-gray-900 backdrop-blur-xl border-2 border-gray-300 dark:border-gray-700 min-h-screen flex-col items-center py-8 shadow-lg"
    >
