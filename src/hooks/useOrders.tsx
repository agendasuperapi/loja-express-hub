...
export const useOrders = () => {
  ...
  const createOrderMutation = useMutation({
    mutationFn: async (orderInput: CreateOrderData) => {
      ...
      // 🎯 Comissão de afiliado é processada automaticamente pelo trigger no banco de dados
      // após os itens serem inseridos (trigger_process_commission_after_items)
      if (validatedData.couponCode) {
        console.log('📊 [AFFILIATE] Comissão será processada automaticamente pelo banco de dados para cupom:', validatedData.couponCode);
      }
